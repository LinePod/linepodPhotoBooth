...
namespace Microsoft.Samples.Kinect.BackgroundRemovalBasics
{
    ...
    public partial class MainWindow : Window, IDisposable
    {
        ...
        private void ButtonScreenshotClick(object sender, RoutedEventArgs e)
        {
            ...
            int colorWidth = this.backgroundFrame.PixelWidth;
            int colorHeight = this.foregroundBitmap.PixelHeight;
        ...
        private void ButtonOpenSkeletonWindow(object sender, RoutedEventArgs e)
        {

            SkeletonWindow skeletonWindow = new SkeletonWindow();
            skeletonWindow.Show();
            this.Close();
        }
